class DrapoModelHandler {
    ...
    public async ResolveModelInputCheckbox(context: DrapoContext, element: HTMLElement, elementJQuery: JQuery, sector: string, model: string, mustache: string, mustacheParts: string[], dataFields: string[], canBind: boolean, modelEvents: string[], canNotify: boolean): Promise<boolean> {
        //Value
    ...
    public async ResolveModelTextArea(context: DrapoContext, el: HTMLElement, sector: string, model: string, mustache: string, mustacheParts: string[], dataFields: string[], canBind: boolean, modelEvents: string[], modelEventsCancel: string[], canNotify: boolean): Promise<boolean> {
        const elj: JQuery = $(el);
        //Value
    ...
    public async ResolveModelInputText(context: DrapoContext, element: HTMLElement, elj: JQuery, sector: string, model: string, mustache: string, mustacheParts: string[], dataFields: string[], canBind: boolean, modelEvents: string[], modelEventsCancel: string[], canNotify: boolean): Promise<boolean> {
        //Value
    ...
    public async ResolveModelInputNumber(context: DrapoContext, element: HTMLElement, elementJQuery: JQuery, sector: string, model: string, mustache: string, mustacheParts: string[], dataFields: string[], canBind: boolean, modelEvents: string[], modelEventsCancel: string[], canNotify: boolean): Promise<boolean> {
        //Value
    ...
    public async ResolveModelInputPassword(context: DrapoContext, element: HTMLElement, elementJQuery: JQuery, sector: string, model: string, mustache: string, mustacheParts: string[], dataFields: string[], canBind: boolean, modelEvents: string[], modelEventsCancel: string[], canNotify: boolean): Promise<boolean> {
        //Value
        const value: string = await this.Application.Solver.ResolveDataPath(context, null, element, sector, mustacheParts, canBind, canBind, modelEvents, modelEventsCancel, canNotify);
        //Text
        const elementInput: HTMLInputElement = element as HTMLInputElement;
    ...
    public async ResolveModelInputHidden(context: DrapoContext, element: HTMLElement, elementJQuery: JQuery, sector: string, model: string, mustache: string, mustacheParts: string[], dataFields: string[], canBind: boolean, modelEvents: string[], canNotify: boolean): Promise<boolean> {
        //Value
    ...
    public async ResolveModelInputRange(context: DrapoContext, element: HTMLElement, elementJQuery: JQuery, sector: string, model: string, mustache: string, mustacheParts: string[], dataFields: string[], canBind: boolean, modelEvents: string[], canNotify: boolean): Promise<boolean> {
        //Value
        const value: string = await this.Application.Solver.ResolveDataPath(context, null, element, sector, mustacheParts, canBind, canBind, modelEvents, null, canNotify);
        //Text
        const elementInput: HTMLInputElement = element as HTMLInputElement;
    ...
    public async ResolveModelSelect(context: DrapoContext, element: HTMLElement, elementJQuery: JQuery, sector: string, model: string, mustache: string, mustacheParts: string[], dataFields: string[], canBind: boolean, modelEvents: string[], canNotify: boolean): Promise<boolean> {
        //Value
        const value: string = await this.Application.Solver.ResolveDataPath(context, null, element, sector, mustacheParts, canBind, canBind, modelEvents, null, canNotify);
        //Selected
