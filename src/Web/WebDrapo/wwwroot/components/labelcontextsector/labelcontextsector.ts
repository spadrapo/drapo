async function labelcontextsectorConstructor(el: HTMLElement, app: any): Promise<LabelContextSector> {
    //Initialize
    let instance: LabelContextSector = new LabelContextSector(el, app);
    await instance.Initalize();
    return (instance);
}

class LabelContextSector {
    //Field
    ...
    public async Initalize(): Promise<void> {
        ...
        const labelContext: LabelContextSector = this;
