...
function checkboxclassConstructor(el, app) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    checkbox = new CheckboxClass(el, app);
                    return [4, checkbox.Initalize()];
                case 1:
                    _a.sent();
                    return [2, (checkbox)];
            }
...
var CheckboxClass = (function () {
    ...
    CheckboxClass.prototype.Initalize = function () {
        return __awaiter(this, void 0, void 0, function () {
            var checkboxValue, checkboxLabel, functionClick, onClick, onClicking, elCheckbox, elLabel;
            return __generator(this, function (_a) {
                ...
                functionClick = this._el.getAttribute('dc-onclick');
                this._el.removeAttribute('dc-onclick');
                onClick = "ToggleItemField(" + checkboxValue + "," + this._notify + ")";
                onClicking = "";
                if (functionClick.length > 0)
                    onClicking = onClick + ";Execute(" + functionClick + ")";
                if (onClicking == "")
                    onClicking = onClick;
                elCheckbox = this._el.children[1].children[0].children[0];
                elCheckbox.setAttribute('d-model', checkboxValue);
                elLabel = this._el.children[1].children[0].children[1];
