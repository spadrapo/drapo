    ...
    Checkbox.prototype.Initalize = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                onClick = "ToggleItemField(" + checkboxValue + ")";
                onClicking = "";
                if (functionClick.length > 0)
                    onClicking = onClick + ";Execute(" + functionClick + ")";
                if (onClicking == "")
                    onClicking = onClick;
                elCheckbox = this._el.children[0].children[0].children[0];
                elCheckbox.setAttribute('d-model', checkboxValue);
                elLabel = this._el.children[0].children[0].children[1];
