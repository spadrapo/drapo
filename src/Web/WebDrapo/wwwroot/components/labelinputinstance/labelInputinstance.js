...
var LabelInputInstance = (function () {
    ...
    LabelInputInstance.prototype.Notify = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sector, dataKey, dataField, caption, label, input, dataItem, value;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sector = this._app.Document.GetSector(this._el);
                        dataKey = this._el.getAttribute("d-dataKeySource");
                        ...
                        return [4, this._app.Storage.RetrieveData(dataKey, sector)];
                    case 1:
                        dataItem = _a.sent();
