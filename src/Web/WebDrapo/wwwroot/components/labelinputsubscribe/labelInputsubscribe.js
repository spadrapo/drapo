...
function labelinputsubscribeConstructor(el, app) {
    return __awaiter(this, void 0, void 0, function () {
        var instance;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    instance = new LabelInputSubscribe(el, app);
...
var LabelInputSubscribe = (function () {
    function LabelInputSubscribe(el, app) {
        this._el = null;
        this._sector = null;
        this._el = el;
        this._app = app;
