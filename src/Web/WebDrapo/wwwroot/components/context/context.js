...
var Context = (function () {
    ...
    Context.prototype.Initalize = function () {
        return __awaiter(this, void 0, void 0, function () {
            var elFor, elComponent;
            return __generator(this, function (_a) {
                elFor = this.GetElementFor();
                elComponent = this.GetElementComponent();
    ...
    Context.prototype.GetElementFor = function () {
        return this._el.children[0];
    };
    Context.prototype.GetElementComponent = function () {
