...
var DropDownTree = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [3, 6];
                    case 4: return [4, this.ActionClose()];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6: return [2];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this._onClose !== null)) return [3, 2];
                        return [4, this._app.FunctionHandler.ResolveFunctionWithoutContext(this._sector, this._el, this._onClose)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2];
    ...
    DropDownTree.prototype.NotifyModelData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modelDataKey;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        modelDataKey = this._app.Parser.ParseMustache(this._model)[0];
                        return [4, this._app.Observer.Notify(modelDataKey, null, [])];
                    case 1:
                        _a.sent();
                        return [2];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7: return [4, this.ActionClose()];
                    case 8:
                        _a.sent();
                        return [2];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4, this.UpdateModelData(key)];
                    case 3:
                        _a.sent();
                        return [4, this.FillText()];
                    case 4:
    ...
    DropDownTree.prototype.GetModelData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var selections, selectionsAux, datas, firstValue, _a, isKeyValid, datas, firstValue;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this._multiselection) return [3, 5];
                        selections = [];
                        return [4, this._app.Storage.RetrieveDataValue(this._sector, this._model)];
                    case 1:
                        selectionsAux = _b.sent();
                        if (Array.isArray(selectionsAux))
                            selections = selectionsAux;
                        if (!(selections.length === 0 && this._isFirstOrDefault && this._state !== 'opened')) return [3, 4];
                    ...
                    case 3:
                        ...
                        _b.label = 4;
                    case 4: return [2, selections];
                    case 5:
                        if (!(this._keySelected === null)) return [3, 14];
                        _a = this;
                        return [4, this._app.Storage.RetrieveDataValue(this._sector, this._model)];
                    case 6:
                        _a._keySelected = _b.sent();
                        if (!(this._keySelected != null)) return [3, 14];
                        if (!((this._keySelected != '') && (this._isEnsureValidSelection))) return [3, 8];
                    ...
                    case 7:
                        ...
                        if (!isKeyValid)
                            this._keySelected = '';
                        return [3, 10];
                    case 8: return [4, this.EnsureNodeVisible(this._keySelected)];
                    case 9:
                        _b.sent();
                        _b.label = 10;
                    case 10:
                        if (!((this._keySelected == '') && (this._isFirstOrDefault))) return [3, 14];
                        return [4, this.GetData()];
                    case 11:
                        datas = _b.sent();
                        return [4, this.GetFirstOrDefaultValue(datas)];
                    ...
                    case 13:
                        _b.sent();
                        _b.label = 14;
                    case 14: return [2, (this._keySelected)];
                }
            });
        });
    };
